    ...
    private fun cargarPais(){
        this@NuevaSucursal.lifecycleScope.launch {
            try {
                ...
                val adaptadorPais =
                    ArrayAdapter(this@NuevaSucursal, R.layout.simple_spinner_item, listaPais)
        ...
        this@NuevaSucursal.lifecycleScope.launch {
            try{
                ...
                val adaptadorMunicipio =
                    ArrayAdapter(this@NuevaSucursal, R.layout.simple_spinner_item, listaMunicipos)
    ...
    private fun cargarDistrito(){
        this@NuevaSucursal.lifecycleScope.launch {
            try{
                ...
                val distritos =
                    ArrayAdapter(this@NuevaSucursal, R.layout.simple_spinner_item, listaDistritos)
    ...
    private fun cargarRutas(){
        this@NuevaSucursal.lifecycleScope.launch {
            try{
                ...
                val rutas =
                    ArrayAdapter(this@NuevaSucursal, R.layout.simple_spinner_item, listaRustas)
