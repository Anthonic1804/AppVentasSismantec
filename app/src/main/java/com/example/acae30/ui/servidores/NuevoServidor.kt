                        ...
                        lifecycleScope.launch(Dispatchers.IO) {
                            ...
                            if(idServidorActivo == idServidor){
                                withContext(Dispatchers.Main) {
                                    Toast.makeText(
                                        this@NuevoServidor,
                                        "NO SE PUEDE ELIMINAR EL SERVIDOR QUE ESTÁ ACTIVO ACTUALMENTE",
                                        Toast.LENGTH_SHORT
                                    )
                                        .show()
                                }
            ...
            withContext(Dispatchers.Main) {
                ...
                if (hayInternet) {
                    if (conexionController.validarDatosConexion(ip, nombre)) {
                        ...
                        val respuesta = conexionController.verificarConexionServidor(
                            ip,
                            puerto,
                            sslActivo,
                            this@NuevoServidor
                        ...
                        if (respuesta == "Conexion Exitosa") {
                            ...
                            if (proceso.contains("editar")) {
                                ...
                                Toast.makeText(
                                    this@NuevoServidor,
                                    "SE ACTUALIZO CORRECTAMENTE EL SERVIDOR",
                                    Toast.LENGTH_SHORT
                                )
                                    .show()
                            } else {
                            ...
                            Toast.makeText(
                                this@NuevoServidor,
                                "ERROR AL CONEXION CON EL SERVIDOR",
                                Toast.LENGTH_SHORT
                            )
                                .show()
                        }
                        ...
                        Toast.makeText(
                            this@NuevoServidor,
                            "DATOS INCORRECTOS EN LA CONEXION",
                            Toast.LENGTH_SHORT
                        )
                            .show()
                    }
