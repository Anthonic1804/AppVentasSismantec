                    ...
                    val adapter = InventarioAdapter(list, this, vistaInventario) { position ->
                        ...
                        if (!pedidoSinExistencia && existeniasProducto <= 0f) { //!pedidoSinExistencia && existeniasProducto <= 0f
                            ...
                            when (vista) {
                                "devolucion" -> {
                                    val encontrado =
                                        solicitudDevolucion.obtenerProductoEnDevolucion(
                                            this@ListadoProductosSolicitud,
                                    ...
                                    if (encontrado) {
                                        Toast.makeText(
                                            this@ListadoProductosSolicitud,
                                            "EL PRODUCTO YA ESTÁ AGREGADO AL DETALLE DE LA DEVOLUCION",
                                            Toast.LENGTH_SHORT
                                        )
                                            .show()
                                    } else {
                                        val intento =
                                            Intent(this, AgregarProductosDevolucion::class.java)
                                        ...
                                        intento.putExtra(
                                            "existencia",
                                            list[position].Existencia!!.toFloat()
                                        )
                                    ...
                                    val intento = Intent(
                                        this@ListadoProductosSolicitud,
                                        AgregarProductoSolicitud::class.java
                                    )
                                    ...
                                    intento.putExtra(
                                        "costoIva",
                                        list[position].costo_iva!!.toFloat()
                                    )
                                    intento.putExtra("precio_u", list[position].Precio!!.toFloat())
                                    intento.putExtra(
                                        "precio_u_iva",
                                        list[position].Precio_iva!!.toFloat()
                                    )
