...
class NuevoAbono : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val formaPago = ArrayAdapter<String>(this@NuevoAbono, R.layout.simple_spinner_dropdown_item)
    ...
    private fun cargarSucursales() {
        ...
        val adaptador = ArrayAdapter(this@NuevoAbono, R.layout.simple_spinner_item, listSucursal)
