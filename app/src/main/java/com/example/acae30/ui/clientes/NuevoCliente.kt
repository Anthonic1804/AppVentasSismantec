...
//                }
        ...
        binding.spMunicipio.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
            override fun onItemSelected(parent: AdapterView<*>?,
                                        view: View?,
                                        position: Int,
                                        id: Long) {
        ...
        binding.spRuta.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
            override fun onItemSelected(parent: AdapterView<*>?,
                                        view: View?,
                                        position: Int,
                                        id: Long) {
        ...
        binding.spContribuyente.onItemSelectedListener = object :
            AdapterView.OnItemSelectedListener {
            override fun onItemSelected(parent: AdapterView<*>?,
                                        view: View?,
                                        position: Int,
    ...
    private fun cargarPais(){
        this@NuevoCliente.lifecycleScope.launch {
            try {
                ...
                val adaptadorPais =
                    ArrayAdapter(this@NuevoCliente, R.layout.simple_spinner_item, listaPais)
                adaptadorPais.setDropDownViewResource(com.example.acae30.R.layout.support_simple_spinner_dropdown_item)
    ...
    private fun cargarDepartamento(){
        this@NuevoCliente.lifecycleScope.launch {
            try{
                ...
                val departamento = ArrayAdapter(
                    this@NuevoCliente,
                    R.layout.simple_spinner_item,
                    listaDepartamentos
                )
                departamento.setDropDownViewResource(com.example.acae30.R.layout.support_simple_spinner_dropdown_item)
    ...
    private fun cargarMunicipio(){
        this@NuevoCliente.lifecycleScope.launch {
            try{
                ...
                val adaptadorMunicipio =
                    ArrayAdapter(this@NuevoCliente, R.layout.simple_spinner_item, listaMunicipos)
                adaptadorMunicipio.setDropDownViewResource(com.example.acae30.R.layout.support_simple_spinner_dropdown_item)
    ...
    private fun cargarDistrito(){
        this@NuevoCliente.lifecycleScope.launch {
            try{
                ...
                val distritos =
                    ArrayAdapter(this@NuevoCliente, R.layout.simple_spinner_item, listaDistritos)
                distritos.setDropDownViewResource(com.example.acae30.R.layout.support_simple_spinner_dropdown_item)
    ...
    private fun cargarRutas(){
        this@NuevoCliente.lifecycleScope.launch {
            try{
                ...
                val rutas =
                    ArrayAdapter(this@NuevoCliente, R.layout.simple_spinner_item, listaRustas)
                rutas.setDropDownViewResource(com.example.acae30.R.layout.support_simple_spinner_dropdown_item)
    ...
    private fun cargarContribuyente(){
        this@NuevoCliente.lifecycleScope.launch {
            try {
                val contribuyente =
                    ArrayAdapter<String>(this@NuevoCliente, R.layout.simple_spinner_dropdown_item)
                if(vista == "editar"){
