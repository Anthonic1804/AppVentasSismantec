                    ...
                    if(respuesta.isNotEmpty() && respuesta.last().id != 0){
                        ...
                        val item = respuesta.map {
                            ClientesEntity(
                                ...
                                dteGiro = it.dteGiro.orEmpty(),
                                ruta = it.ruta,
                                dteDireccion = it.dteDireccion.orEmpty(),
                                dteCodDepto = it.dteCodDepto.orEmpty(),
                                dteCodMunicipio = it.dteCodMunicipio.orEmpty(),
                                dteCodPais = it.dteCodPais.orEmpty(),
                                dtePais = it.dtePais.orEmpty(),
                                dteCorreo = it.dteCorreo.orEmpty(),
                                dteTelefono = it.dteTelefono.orEmpty(),
                                latitudApp = it.latitudApp,
                                longitudApp = it.longitudApp,
                                nombreComercial = it.nombreComercial,
                                mayorista = it.mayorista,
                                dteCodGiro = it.dteCodGiro.orEmpty(),
                                dteDistrito = it.dteDistrito.orEmpty(),
                                dteCodDistrito = it.dteCodDistrito.orEmpty()
                            )
                        }
