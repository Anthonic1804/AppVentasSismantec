...
/**
 * REFACTORIZACIÓN MVVM: Caso de Uso para crear un pedido directamente saltándose la visita.
 * Utilizado exclusivamente cuando 'tipoVentaLocal' es verdadero.
 */
class CrearPedidoDirectoUseCase(
    ...
    suspend fun ejecutar(idCliente: Int): Int {
        // 1. Obtenemos los datos completos del cliente desde Room
        val cliente = clientesRepository.obtenerClientePorId(idCliente)
            ?: throw Exception("Cliente no encontrado")

        // 2. Determinamos el tipo de documento (Lógica de negocio migrada)
        ...
        // 3. Solicitamos la creación del pedido al repositorio con valores por defecto para Local
